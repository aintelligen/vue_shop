			...
			<div class="md-modal-inner">
				...
				<div class="md-content">
					<div class="confirm-tips">
						<div class="error error-wrap" v-show="errorTip">用户名或者密码错误</div>
						<ul>
							<li class="regi_form_input">
								<i class="icon IconPeople"></i> 
								<input type="text" tabindex="1" name="loginname" placeholder="User Name"  v-model = "userName" class="regi_login_input regi_login_input_left">
							</li> 
